...
#ifndef NFD_DAEMON_FW_BEST_ROUTE_BREADCRUMBS_STRATEGY_HPP
#define NFD_DAEMON_FW_BEST_ROUTE_BREADCRUMBS_STRATEGY_HPP
...
/** \brief Best Route strategy with breadcrumbs support version 1
 *
 *  This strategy forwards a new Interest to either the lowest-cost next hop (except downstream) 
 *  or the hop shown by breadcrumbs.
 ...
 */
class BestRouteBCStrategy : public Strategy
                         , public ProcessNackTraits<BestRouteBCStrategy>
{
public:
  explicit
  BestRouteBCStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
...
#endif // NFD_DAEMON_FW_BEST_ROUTE_BREADCRUMBS_STRATEGY_HPP
