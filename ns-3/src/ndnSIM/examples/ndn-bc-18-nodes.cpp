...
main(int argc, char* argv[])
{
  ...
  ndn::StrategyChoiceHelper::InstallAll(prefix, "/localhost/nfd/strategy/best-route-breadcrumbs");
  ...
  std::string pcap_trace("bc-trace.pcap");
  std::string app_delay_trace("bc-app-delay-trace.txt");
  std::string rate_trace("bc-rate-trace.txt");
